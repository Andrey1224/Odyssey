  ...
  const renderCard = (id: string, Icon: React.ElementType, label: string, subLabel: string) => {
    ...
    return (
      <div
        ...
        className={`cursor-pointer p-6 rounded-xl border-2 transition-all duration-200 text-left bg-white group ${
          isSelected
      ...
      >
        <div className="flex justify-between mb-4">
          ...
          <div className={`transition-all duration-300 ${isSelected ? "opacity-100 scale-100" : "opacity-0 scale-50"}`}>
            <CheckCircle className="text-teal-600" size={22} fill="currentColor" color="white" />
          </div>
        </div>
