  ...
  return (
    <aside className="w-full shrink-0 space-y-8 lg:w-72">
      ...
      <div className="mb-6 rounded-lg bg-slate-900 p-5 text-center text-white">
        ...
        <button onClick={() => openWizard("walk-in-shower-baths")} className="mt-2 inline-block w-full rounded bg-cream-50 px-4 py-2 text-[0.9rem] font-semibold text-slate-900 transition-colors hover:bg-slate-100">
          Help Me Choose
        </button>
      </div>
