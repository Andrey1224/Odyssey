      ...
      <section className="bg-cream-50 py-16 border-y-4 border-teal-700/10">
        <div className="max-w-3xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <h2 className="font-serif text-2xl md:text-4xl text-slate-900 font-bold mb-2">
            &ldquo;Respect, Not Targets&rdquo;
          </h2>

          <blockquote className="text-xl md:text-2xl text-slate-600 italic leading-relaxed mb-10 max-w-2xl">
            &ldquo;At Odyssey, we believe choosing a bath is a decision for your future independence. We are strictly against aggressive sales calls.&rdquo;
          </blockquote>
