  ...
  return (
    <div className="bg-cream-50 font-sans text-slate-900 pb-24">
      ...
      <section className="py-16 px-6 md:px-8 max-w-6xl mx-auto print:hidden">
        <h2 className="text-2xl font-bold text-slate-900 mb-8 text-center md:text-left">Privacy at a glance:</h2>
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-3">We never sell data</h3>
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-3">Highly Secure</h3>
            <p className="text-base text-slate-600 leading-relaxed">
        ...
        <div className="bg-white rounded-2xl p-8 md:p-14 border border-slate-200 shadow-sm">
          ...
          <div className="bg-teal-50 border border-teal-100 p-6 md:p-8 rounded-2xl mb-8">
            <div className="flex items-center gap-3 mb-3">
              <HeartPulse className="text-teal-700 shrink-0" size={28} />
              <p className="m-0 text-xl font-bold text-slate-900">Health Data &amp; VAT Relief</p>
            </div>
      ...
      <section className="px-6 md:px-8 max-w-4xl mx-auto mt-12 mb-12 print:hidden">
        <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl p-8 md:p-12 text-white">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            <div>
              <h3 className="font-serif text-2xl md:text-3xl font-bold mb-3 flex items-center gap-3">
